...
const int Renderer::_cSize = 10;
const int Renderer::_bSize = 8;

const char Renderer::_bCell = (char)176;
const char Renderer::_wCell = (char)219;
...
void Renderer::moveSelector(POINT pos) {
	pos.x /= Renderer::_cSize;
	pos.y /= Renderer::_cSize;

	this->selector.row = pos.y;
	this->selector.col = pos.x;
}
