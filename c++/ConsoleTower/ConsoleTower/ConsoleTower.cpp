// ConsoleTower.cpp : Defines the entry point for the console application.
//
...
void gamePause(Engine &dr) {
	dr.clear();
	dr(width/2-18,height/2,"Game paused, press [enter] to resume!");
	dr.draw();
	while (true) {
		Sleep(10);
